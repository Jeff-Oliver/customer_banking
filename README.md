...
2. [x] Imports the Account class from the Accounts.py file.
...
2. [x] Prompt the user to set the savings balance, interest rate, and months for the savings account.
